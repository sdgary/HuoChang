...
import byxx.android.huochang.dw.others.DWSortMenuFragment;
...
//		rgdm = getIntent().getStringExtra("MBLgdm");
//		if(rgdm != null){
//			for(int i= 0 ;i<CONTENT.length;i++){
//				if(rgdm.equals(CONTENT[i])){
...
//		}
		...
		mMenuFragment = new DWSortMenuFragment();
	...
	class MyAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			return AcDWFragment.newInstance(CONTENT[position]);//(CONTENT[position % CONTENT.length]);
		}
