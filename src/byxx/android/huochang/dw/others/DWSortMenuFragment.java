package byxx.android.huochang.dw.others;
...
public class DWSortMenuFragment extends Fragment {

	private ListView mSortList;
	Button gohome;
	public DWSortListAdapter mSortListAdapter;
//	private PullPersonPaseService mPullPersonPaseService = null;
	private AcNewDw acNewDw;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mSortList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				acNewDw.onPageChangeListener.onPageSelected(arg2);
				acNewDw.toggle();
			}
		});
