package byxx.android.huochang.traininfo.others;
...
public class SortMenuFragment extends Fragment {
	...
	Button gohome;
	public SortListAdapter mSortListAdapter;
//	private PullPersonPaseService mPullPersonPaseService = null;
	private AcNewTrainInfo NewTrainInfo;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
	    ...
	    NewTrainInfo = (AcNewTrainInfo) getActivity(); 
		...
		mSortList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				NewTrainInfo.onPageChangeListener.onPageSelected(arg2);
				NewTrainInfo.toggle();
			}
		});
