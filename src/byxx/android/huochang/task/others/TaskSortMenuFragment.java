package byxx.android.huochang.task.others;
...
import byxx.android.huochang.task.AcNewTask;
...
public class TaskSortMenuFragment extends Fragment {

	private ListView mSortList;
	Button gohome;
	public TaskSortListAdapter mSortListAdapter;
//	private PullPersonPaseService mPullPersonPaseService = null;
	private AcNewTask acNewTask;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mSortList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				acNewTask.onPageChangeListener.onPageSelected(arg2);
				acNewTask.toggle();
			}
		});
